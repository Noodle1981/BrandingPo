...
```mermaid
erDiagram
    CICLO_CAMPANA ||--o{ CANDIDATO : agrupa
    CICLO_CAMPANA ||--o{ PLAN_CAMPANA : enmarca
    ...
    CICLO_CAMPANA {
        int id
        int anio "2023, 2024, 2025, 2026"
        string nombre "Campaña Municipal 2023, Elecciones Legislativas 2025, etc."
        date fecha_inicio
        date fecha_fin
        string estado "planificacion, activa, finalizada, archivo"
    }
    ...
    CANDIDATO {
        int id
        int ciclo_campana_id
        string nombre_completo
        string partido_coalicion
        string cargo_aspirado "Intendente, Concejal, Diputado, Gobernador"
        string estado_politico "precandidato, candidato, intendente_electo, gobernador_electo, en_funciones, opositor, inactivo"
    ...
    PUBLICACION {
        ...
        decimal monto_invertido_pauta "Monto en $ invertido si fue pauta"
        int vistas_organicas
        int vistas_pagadas
        string url_post
