...
<template>
  ...
  <WarRoomLayout>
    <div class="space-y-6">
      ...
      <!-- 2. KPIs de Audiencia Real y Padrón Territorial (Tiers) -->
      <CandidatoKpisTerritoriales
        :candidato="candidato"
        tema="propio"
      />

      <!-- 3. Semáforo y Selector de Canales Oficiales en 1 Fila -->
      ...
      <!-- 4. Ficha Técnica de Punto Cero del Canal Seleccionado y Acciones -->
      <CandidatoCanalFicha
        :red="currentRed"
        :candidato="candidato"
        tema="propio"
