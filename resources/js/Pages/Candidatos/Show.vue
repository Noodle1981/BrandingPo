...
<template>
  ...
  <WarRoomLayout>
    ...
    <!-- 2. Pestañas de Redes Sociales del Rival (Grid de 7 Canales en 1 Sola Fila con Logos Oficiales) -->
    <div class="space-y-4">
      <div class="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-7 lg:grid-cols-7 gap-2.5 sm:gap-3">
        ...
        >
          ...
          <button
            ...
            class="absolute top-1.5 right-1.5 p-1 rounded-lg text-slate-400 hover:text-purple-500 hover:bg-slate-100 dark:hover:bg-slate-800 transition-all cursor-pointer"
